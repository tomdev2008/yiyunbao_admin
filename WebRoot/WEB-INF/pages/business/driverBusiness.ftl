...
<body>
        ...
        url="/admin/business/queryDriverBusiness/${driverId}" allowResize="true" idField="id" multiSelect="true" allowAlternating="true" pageSize="10" showEmptyText="true" emptyText="暂无"> 
