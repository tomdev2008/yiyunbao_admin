...
<body>
        <div class="mini-toolbar" style="border-bottom:0;padding:0px;">
            <table style="width:100%;">
                <tr>
                    <td style="width:100%;">
                    	<!--<a class="mini-button" iconCls="icon-add" onclick="add()">添加司机</a>-->
                    ...
                    <td style="white-space:nowrap;">
                        ...
                        <input id="recommender" class="mini-textbox" emptyText="推荐人账号" style="width:150px;" onenter="search"/>  
        ...
        url="/admin/driver/queryValidList" allowResize="true" idField="id" multiSelect="true" allowAlternating="true" pageSize="20" > 
...
<form id="excelForm"  action="/admin/driver/exportExcel" method="post" target="excelIFrame">
    </form>
...
<script>
    ...
    function search() {
        ...
        grid.load({ phone: phone , name : name , id_card : id_card , plate_number : plate_number , car_type : car_type, recommender:recommender});
    }
    ...
    function delRow(row_uid) {
     ...
     function showOrder(row_uid) {
            ...
            if (row) {
		         mini.open({
	                url: "/admin/order/driverOrder/" + row.id,
	                title: "查看订单", 
	                width: 800, 
	                height: 360
	            });
     ...
     function showBusiness(row_uid) {
            ...
            if (row) {
		         mini.open({
	                url: "/admin/business/driverBusiness/" + row.id,
	                title: "查看交易", 
	                width: 700, 
	                height: 360
	            });
     ...
     function showRecharge(row_uid) {
            ...
            if (row) {
		         mini.open({
	                url: "/admin/recharge/driver/" + row.id,
	                title: "充值", 
	                width: 300, 
	                height: 150
	            });
