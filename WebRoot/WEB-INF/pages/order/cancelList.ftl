...
<body>
        ...
        url="/admin/order/query?status=4" allowResize="true" idField="id" multiSelect="true" allowAlternating="true" pageSize="20" > 
        <div property="columns">
        	<div name="action" width="200" align="center" headerAlign="center"  renderer="onActionRenderer">操作</div>
