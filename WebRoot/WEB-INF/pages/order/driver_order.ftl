...
<body>
        ...
        url="/admin/order/queryDriverOrder/${driverId}" allowResize="true" idField="id" multiSelect="true" allowAlternating="true" pageSize="10" > 
        <div property="columns">
            ...
            <div field="vie_status" allowSort="true">
            	竞标状态
            </div>            
    ...
    grid.on("drawcell", function (e) {
        ...
        if (field == "vie_status") {
        	if(value == 0){
            	...
            	e.cellHtml = "<font color='red'>退出竞标</font>";
            }
            else{
            	e.cellHtml = "未知";
            }
