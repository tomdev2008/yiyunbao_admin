...
<body>
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="white-space:nowrap;">
                        <input id="btnEdit1" class="mini-buttonedit" onbuttonclick="onButtonEdit" emptyText="出发地"/>    
                ...
                <tr>
                    ...
                    <td style="white-space:nowrap;">
                        ...
                        <input id="status" class="mini-combobox" style="width:150px;" textField="text" valueField="status" emptyText="状态" url="/admin/order/showStatus" showNullItem="true"/>
        ...
        <div property="columns">
        	<div name="action" width="200" >操作</div>
            <div field="status" allowSort="true">
            	状态
            </div>            
            <div field="user_name" >
            	货主
...
<script>
    ...
    function onActionRenderer(e) {
        ...
        var s = ' <a   href="javascript:delRow(\'' + uid + '\')">删除</a>'
        		...
        		+ ' <a   href="javascript:delRow(\'' + uid + '\')">查看交易</a>' ;
        return s;
    }
