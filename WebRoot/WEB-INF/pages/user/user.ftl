...
<body>
        <div class="mini-toolbar" style="border-bottom:0;padding:0px;">
            <table style="width:100%;">
                <tr>
                    <td style="width:100%;">
                    	<a class="mini-button" iconCls="icon-add" onclick="add()">添加货主</a>
                    ...
                    <td style="white-space:nowrap;">
                        ...
                        <input id="company_name" class="mini-textbox" emptyText="公司名称" style="width:150px;" onenter="search"/>  
                        <input id="name" class="mini-textbox" emptyText="联系人" style="width:150px;" onenter="search"/>  
        ...
        url="user/query" allowResize="true" idField="id" multiSelect="true" allowAlternating="true" pageSize="20" > 
