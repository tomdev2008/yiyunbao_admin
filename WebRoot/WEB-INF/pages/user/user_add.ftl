            ...
            <form id="form1" method="post">
            	<table style="table-layout:fixed;">
                    <tr>
                        ...
                        <td style="width:100px;"><font color="red">*</font>密码：</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="company_name" class="mini-textbox" required="true" />
                        </td>
                    ...
                    <tr>
                        <td>推荐人：</td>
                        <td>
                            <input name="recommender" class="mini-textbox" required="false" />
                        </td>
                        <td>身份证号码：</td>
                        <td>
                    ...
                    <tr>
                        <td>座机：</td>
                        <td>
                            <input name="telcom" class="mini-textbox" />
                        </td>
                        <td>地址：</td>
                        <td>
                    ...
                    <tr>
                        <td>营业执照：</td>
                        <td>
                        	<input class="mini-hidden" id="licence_photo" name="licence_photo" />
				          	<img id="main_img_path" src="" width="50" height="50"/>
