...
<body>
        ...
        url="/admin/userReply/queryOrderReply/${orderId}" allowResize="true" idField="id" multiSelect="true" allowAlternating="true" pageSize="10" showEmptyText="true" emptyText="暂无评价"> 
            	 ...
            	 mini.confirm("确定删除记录？", "确定？",
		            function (action) {            
		                if (action == "ok") {
		                    ...
		                    $.ajax({
		                        url: "/admin/userReply/delete/" + row.id,
