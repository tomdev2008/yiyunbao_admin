            	...
            	<table style="table-layout:fixed;">
                    <tr>
                        ...
                        <td style="width:150px;">
                            <input id="vender_province" class="mini-textbox" onfocus="onSelectProvince" emptyText="省/直辖市" required="false"/>
                            <input id="vender_province_id" name="vender_province" class="mini-hidden"/>
                        </td>
                        <td style="width:150px;">
                            <input id="vender_city" class="mini-textbox" onfocus="onSelectCity" emptyText="地市" />
                            <input id="vender_city_id" name="vender_city" class="mini-hidden"/>
                        </td>
                        <td style="width:150px;">
                            <input id="vender_district" class="mini-textbox" onfocus="onSelectDistrict" emptyText="区县"/>
                            <input id="vender_district_id" name="vender_district" class="mini-hidden"/>
                        </td>
                    </tr>
                    <tr>
                        <td style="width:100px;"><font color="red">*</font>商家名称：</td>
                        <td>
                            <input name="vender_name" class="mini-textbox" required="true" />
                        </td>
                        <td style="width:100px;"><font color="red">*</font>商品名称：</td>
                        <td>
                            <input name="goods_name" class="mini-textbox" required="true"  />
                        </td>
                    </tr>
                    <tr>
                        <td><font color="red">*</font>商家地址：</td>
                        <td>
                            <input name="vender_address" class="mini-textbox" required="true" />
                        </td>
                    ...
                    <tr>
                        <td>联系手机：</td>
                        <td>
                            <input name="vender_mobile" class="mini-textbox" required="false" />
                        </td>
                        <td><font color="red">*</font>联系电话：</td>
                        <td>
                            <input name="vender_phone" class="mini-textbox" required="true"/>
                        </td>
                    </tr>
                    <tr>
                        <td>正常价格：</td>
                        <td>
                            <input name="normal_price"  class="mini-spinner" value="0" minValue="0" maxValue="2000000" required="true" />
                        </td>
                        <td>会员特惠：</td>
                        <td>
                            <input name="member_price" class="mini-spinner" value="0" minValue="0" maxValue="2000000" required="true"/>
                        </td>
                        <input class="mini-hidden" id="longitude" name="longitude" value="116.403119">
                        <input class="mini-hidden" id="latitude" name="latitude" value="39.915156">
                    </tr>   
                    <tr>
                        <td>分类：</td>
                        <td>
                            <input id="category" name="category" class="mini-combobox" style="" textField="name" valueField="id" emptyText="请选择类别" url="/admin/dict/getListByType/vender_category" showNullItem="false"/>
                        </td>
                        <td>其他：</td>
                        <td>
                            <input name="other"  class="mini-textbox"  required="true"/>
                        </td>
                    </tr>
                </table>
                <!--地图-->
